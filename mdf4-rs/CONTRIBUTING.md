...
The maintained copy for the Pelorus ecosystem lives in the **[pelorus-marine/platform](https://github.com/pelorus-marine/platform)** repository under **`mdf4-rs/`**. Prefer opening changes and issues there so **`pelorus-core`** and workspace CI stay in sync.
