...
pelorus-inspector is available under a **dual-licensing** model:
...
This means you can use pelorus-inspector in:
...
For commercial licensing inquiries, pricing, and terms, please [open an issue on **`pelorus-marine/platform`**](https://github.com/pelorus-marine/platform/issues).
...
By contributing to pelorus-inspector, you agree that your contributions will be
