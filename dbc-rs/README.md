...
**[Pelorus Marine](https://github.com/pelorus-marine)** curates this tree for the full Pelorus stack. The crates.io package name **`dbc-rs`** is **unchanged** for semver continuity. Earlier standalone development and contributors are **upstream lineage** — acknowledged with gratitude; see **[`../CONTRIBUTORS.md`](../CONTRIBUTORS.md)**.
